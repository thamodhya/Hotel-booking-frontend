        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="King Hotel" className="header-image" />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">King Hotel</span></h2>
